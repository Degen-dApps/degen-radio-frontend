      ...
      <div class="col-10 col-md-11 post-sizing">
        ...
        <p class="card-subtitle mb-2 text-muted">
          ...
          <span v-if="post.timestamp">
            ·
            <NuxtLink class="link-without-color hover-color" :to="'/post/?id=' + post.stream_id">{{
              timeSince
            }}</NuxtLink></span
          >
        </p>
        ...
        <div @click="openPostDetails">
          <p class="card-text text-break" v-if="parsedText.length > postLengthLimit && !showFullText">
            <span v-html="parsedText.substring(0, postLengthLimit) + ' ... '"> </span>
        ...
        <p class="card-subtitle mt-3 text-muted">
          <span>
            <i
              ...
              :class="alreadyLiked ? 'bi bi-heart-fill text-primary' : 'bi bi-heart'"
            ></i>
            {{ post.count_likes }}
          </span>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button
              :disabled="!userStore.getIsConnectedToOrbis || waitingReply"
              type="button"
